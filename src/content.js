 ...
 * Every entry hangs on the board from the first frame - there are no
 * conditional crates, so this list is the single source of truth for how
 * many there are to knock down.
 */
export const sections = [
  {
    ...
    intro:
      "Internships, mentorship, and the open-source work that taught me the most.",
    type: "timeline",
    items: [
      {
        role: "TLDP Mentor",
      ...
      },
      {
        ...
        bullets: [
          "Built <strong>Pulse</strong>, an attendance management system with Next.js, React.js, MongoDB and MUI. It is to be used company-wide as a user-friendly replacement for spreadsheet-based attendance.",
          ...
          "We used Jira for teamwork and Slack for communication.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "Reported progress in weekly standup meetings with team members & faculty mentors.",
        ],
      },
    ],
  },

  {
    ...
    kicker: "02 · Projects",
    intro:
      "From GPU kernels to drone-based crowd safety - each one started as an obsession.",
    type: "cards",
    items: [
      {
        ...
        icon: "🛸",
        desc: "Computer-vision system that detects crowd stampede conditions from aerial drone footage in real time. Detection and density models in PyTorch and OpenCV, served through a React and Next.js based architecture backed by MUI for styling and Supabase for storage. Final year project at FAST-NUCES, due April 2027.",
        tags: [
          "Python",
          "PyTorch",
          "OpenCV",
        ...
        link: "https://github.com/Ahmar004/Sentinel",
      },
      {
        name: "Pulse - Attendance Management System",
        badge: "CitrusBits",
        icon: "📊",
        desc: "A full-stack app serving a user-friendly attendance platform replacing spreadsheet workflows for attendance management at CitrusBits. Next.js & MongoDB on the back end. React.js, Next.js and MUI on the front end. Vercel for deployment and GCP (Google Cloud Platform) for authentication.",
        tags: [
          "React.js",
          "Next.js",
          "MongoDB",
        ...
        link: "https://github.com/r8928/pulse-app",
      },
      {
        name: "KLT Feature Tracker - HPC Optimisation",
        icon: "⚡",
        desc: "I optimized the Kanade–Lucas–Tomasi image feature tracker. Achieved 4× speedup by moving the embarrassingly parallel parts of code onto the GPU using CUDA, OpenACC directives and Numba in Python.",
      ...
      },
      {
        ...
        icon: "📂",
        oss: true,
        desc: "Student resource platform for my university, FAST-NUCES. It serves 1,700+ FASTians, with GitHub Actions automating contribution review for ease in addition of newer helpful resources.",
      ...
      },
      {
        ...
        icon: "🌐",
        oss: true,
        desc: "A platform for sharing helpful online resources related to CS related skills in the tech industry. 800+ members and growing, contributions managed through automated GitHub Actions workflows.",
        tags: ["Vanilla JS", "GitHub Actions", "Community"],
      ...
      },
      {
        ...
        icon: "🇵🇸",
        oss: true,
        desc: "Founded an open-source awareness platform to share verified organizations and individuals. Contributed remotely with two other voluntary contributors in improving the interface using React.js.",
    ...
    items: [
      {
        ...
        status: "Certified",
        icon: "🤖",
        link: "https://coursera.org/verify/LWGVKQIUTYTS",
      },
      {
        ...
        status: "Certified",
        icon: "🤖",
        link: "https://coursera.org/verify/X4U582M4BCFN",
      },
      {
